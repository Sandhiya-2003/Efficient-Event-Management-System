...
<?php
    ...
    // When form submitted, check and create user session.
        ...
        if ($rows > 0) {
            echo "<table border='1'><tr><th>CHOOSE</th><th>EVENT CODE</th><th>EVENT NAME</th><th>VENUE</th><th>DATE</th><th>START TIME</th><th>EVENT DURATION</th><th>COORDINATOR NAME</th></tr>";
			...
			echo "</table>";
			echo '<input type = "submit" value = "Choose Events" name = "chooseevent">';
